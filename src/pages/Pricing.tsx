        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-lg text-primary-50">
              Découvrez nos formules adaptées à la pratique vétérinaire : de
              l'accès anticipé aux agents IA jusqu'à la digitalisation sur
              mesure. Chez InnoVet Tech, nous mettons l'innovation au service de
              la santé animale et de votre rentabilité.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                title: "ROI mesurable",
                description:
                  "Des résultats concrets et quantifiables pour votre cabinet.",
              },
            ].map((feature, index) => (
            ...
            <dl className="space-y-8">
              {faqs.map((faq, index) => (
                <div key={index} className="bg-neutral-50 p-8 rounded-2xl">
                  ...
                  <dd className="mt-4 ml-9 text-gray-600">{faq.answer}</dd>
                </div>
              ))}
            </dl>
          </div>
