...
import { Brain, Target, Users, Shield, Award, ChevronRight, Lightbulb, Heart, Zap, MessageSquare } from 'lucide-react';
...
const values = [
  {
    ...
    title: "Innovation",
    description: "Nous repoussons constamment les limites de l'innovation pour créer des solutions qui transforment la médecine vétérinaire."
  },
  {
    icon: <Heart className="h-6 w-6" />,
    title: "Passion",
    description: "Notre passion pour la santé animale guide chacune de nos décisions et alimente notre désir d'excellence."
  },
  {
    icon: <Shield className="h-6 w-6" />,
    title: "Fiabilité",
    description: "Nous nous engageons à fournir des solutions fiables et sécurisées sur lesquelles les vétérinaires peuvent compter."
  },
  {
    icon: <Zap className="h-6 w-6" />,
    title: "Excellence",
    description: "Nous visons l'excellence dans tout ce que nous faisons, de la conception à l'assistance client."
  }
];
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-blue-100">
              Une équipe passionnée qui révolutionne la pratique vétérinaire grâce à 
              l'intelligence artificielle et l'innovation numérique.
            </p>
          </div>
        </div>
      </section>
            ...
            {team.map((member, index) => (
              <div key={index} className={`flex flex-col lg:flex-row gap-12 ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                <div className="flex-1">
                  <div className={`aspect-w-4 aspect-h-5 rounded-2xl overflow-hidden shadow-soft ${index === 0 ? 'lg:sticky lg:top-24' : ''}`}>
                    <img
                      src={member.imageUrl}
                      alt={`Portrait de ${member.name}, ${member.role.toLowerCase()} chez InnoVet Tech`}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                <p className="text-gray-600">
                  En plaçant l'innovation et l'humain au cœur de chaque projet, nous souhaitons 
                  créer un futur où chaque praticien dispose de solutions performantes pour exercer 
                  sereinement et avec un impact maximal.
                </p>
            ...
            <div>
              ...
              <div className="space-y-4">
                <p className="text-gray-600">
                  Notre priorité est que chaque vétérinaire puisse se consacrer pleinement aux soins 
